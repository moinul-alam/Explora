        ...
        return (
          <Fade in timeout={500}>
            <Box sx={{ mt: 2, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <MediaCard mediaData={currentMovie} onClick={() => navigate(`/details/${selectedMediaType}/${currentMovie.id}`)} />
              <Stack direction="column" spacing={2} alignItems="center" sx={{ mt: 2, width: '100%' }}>
                <Rating
                  value={currentRating}
