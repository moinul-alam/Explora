...
import useFetchData from "@src/hooks/useFetchData"; // Import your custom hook
            ...
            <Card>
              <CardActionArea>
                <CardMedia
                  component="img"
                  height="140"
                  image={item.poster_path ? `https://image.tmdb.org/t/p/w500${item.poster_path}` : "/default-image.jpg"}
